...
namespace RiderData
{
    public static class NewRider
    {
        ...
        public static void KartSN()
        {
            ...
            NewRider.MaxKart = 1303;
        }

        public static void Kart()
        {
            int All_Kart = NewRider.Kart_X_Cut + NewRider.Kart_Old_Cut;
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1292 || i == 1293 || i == 1294 || i == 1296 || i == 1299 || i == 1300 || i == 1301 || i == 1303) //X
                    {
        ...
        public static void Character()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Character = 348;
                oPacket.WriteInt(Character - 38 - 41);
                for (short i = 1; i <= Character; i++)//Character
                {
                    if (i == 47 || i == 48 || i == 63 || i == 116 || i == 117 || i == 124 || i == 128 || i == 130 || i == 134 || i == 137 ||
                        i == 144 || i == 147 || i == 149 || i == 159 || i == 163 || i == 175 || i == 176 || i == 184 || i == 192 || i == 193 || 
                        i == 194 || i == 195 || i == 196 || i == 197 || i == 231 || i == 239 || i == 245 || i == 246 || i == 247 || i == 265 || 
                        i == 288 || i == 333 || i == 334 || i == 335 || i == 336 || i == 337 || i == 338 || i == 339 ||
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= Pet; i++)
                {
                    if (i == 8 || i == 10 || i == 11 || i == 14 || i == 18 || i == 50 || i == 77 || i == 85 || i == 91 || i == 92 || 
                        i == 105 || i == 107 || i == 120 || i == 136 || i == 143 || i == 156)
                    {
                    }
                    else
                    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= Goggle; i++)
                {
                    if (i == 7 || i == 8 || i == 13 || i == 28 || i == 33 || i == 36 || i == 41 || i == 43 || i == 49 || i == 51 ||
                        ...
                        i == 128 || i == 140 || i == 141 || i == 148 || i == 156 || i == 159 || i == 175)
                    {
                    }
                    else
                    {
        ...
        public static void HeadBand()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HeadBand = 595;
                oPacket.WriteInt(HeadBand + 5 - 47);
                ...
                for (short i = 1; i <= HeadBand; i++)
                {
                    if (i == 16 || i == 21 || i == 23 || i == 29 || i == 37 || i == 39 || i == 40 || i == 41 || i == 43 || i == 44 ||
                        ...
                        i == 503 || i == 506 || i == 527 || i == 529 || i == 531 || i == 551 || i == 577)
                    {
                    }
                    else
                    {
        ...
        public static void HandGearL()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HandGearL = 400;
                oPacket.WriteInt(HandGearL + 6 - 81);
