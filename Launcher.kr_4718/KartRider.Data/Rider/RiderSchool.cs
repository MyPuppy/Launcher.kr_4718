    ...
    public static class RiderSchool
    {
        ...
        public static void PrStartRiderSchool()
        {
            using (OutPacket oPacket = new OutPacket("PrStartRiderSchool"))
            {
                ...
                oPacket.WriteEncFloat(0.6841f + SpeedPatch.DragFactor);
                oPacket.WriteEncFloat(2500f + SpeedPatch.ForwardAccelForce);
                oPacket.WriteEncFloat(2050f);
                oPacket.WriteEncFloat(2340f);
                oPacket.WriteEncFloat(1580f);
                oPacket.WriteEncFloat(10f);
                oPacket.WriteEncFloat(24.9f);
                oPacket.WriteEncFloat(5f);
                oPacket.WriteEncFloat(5f);
                oPacket.WriteEncFloat(0.2f);
                oPacket.WriteEncFloat(0.2f);
                oPacket.WriteEncFloat(0.2f);
                oPacket.WriteEncFloat(4840f + SpeedPatch.DriftEscapeForce);
                oPacket.WriteEncFloat(0.248f + SpeedPatch.CornerDrawFactor);
                oPacket.WriteEncFloat(0.06f);
                oPacket.WriteEncFloat(0.01f);
                oPacket.WriteEncFloat(4320f + SpeedPatch.DriftMaxGauge);
                ...
                oPacket.WriteEncFloat(1.847f + SpeedPatch.TransAccelFactor);
                oPacket.WriteEncFloat(1.5f + SpeedPatch.BoostAccelFactor);
                oPacket.WriteEncFloat(1000f);
                oPacket.WriteEncFloat(1500f);
                oPacket.WriteEncFloat(2500f + SpeedPatch.StartForwardAccelForceItem);
                oPacket.WriteEncFloat(4083.235f + SpeedPatch.StartForwardAccelForceSpeed);
